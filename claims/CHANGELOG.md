...
- Confidence weight tests use `math.isclose` instead of exact float equality for `DEFAULT_SOURCE_WEIGHTS`
  static-analysis weight (avoids floating-point equality code smells).
